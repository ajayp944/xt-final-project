...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\nexports.controlProductCart = undefined;\n\nvar _base = __webpack_require__(/*! ./views/base */ \"./src/js/views/base.js\");\n\nvar _Cart = __webpack_require__(/*! ./models/Cart */ \"./src/js/models/Cart.js\");\n\nvar _Cart2 = _interopRequireDefault(_Cart);\n\nvar _cartView = __webpack_require__(/*! ./views/cartView */ \"./src/js/views/cartView.js\");\n\nvar cartView = _interopRequireWildcard(_cartView);\n\nfunction _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step(\"next\", value); }, function (err) { step(\"throw\", err); }); } } return step(\"next\"); }); }; }\n\nvar cState = {};\n\n//Cart\n\n\n// On window load get data\nwindow.addEventListener('load', function () {\n    //Cart Items\n    controlCartItems();\n});\n\nvar controlCartItems = function controlCartItems() {\n\n    // Cart \n    cState.cart = new _Cart2.default();\n    // Get cart items\n    var cartList = cState.cart.getNumcartItem();\n\n    //Render cart item\n    renderCartItems();\n};\n\nvar renderCartItems = function renderCartItems() {\n    cartView.clearCart();\n    cState.cart.getNumcartItem();\n    cartView.renderCartItems(cState.cart.cartItems);\n};\n\nvar controlProductCart = exports.controlProductCart = function () {\n    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(prId, type) {\n        var index, product;\n        return regeneratorRuntime.wrap(function _callee$(_context) {\n            while (1) {\n                switch (_context.prev = _context.next) {\n                    case 0:\n\n                        try {\n                            index = cState.cart.cartItems.findIndex(function (el) {\n                                return el.id === prId;\n                            });\n                            product = cState.cart.cartItems[index];\n\n\n                            cState.cart.addToCart(product.id, product.name, product.price, product.imageURL, product.stock, 1, type);\n\n                            cState.cart.getNumcartItem();\n                        } catch (err) {\n                            console.log(err);\n                        }\n\n                    case 1:\n                    case 'end':\n                        return _context.stop();\n                }\n            }\n        }, _callee, undefined);\n    }));\n\n    return function controlProductCart(_x, _x2) {\n        return _ref.apply(this, arguments);\n    };\n}();\n\n_base.elements.headerUserItemsCart.addEventListener('click', function (e) {\n    renderCartItems();\n    OpenPopup();\n});\n\n_base.elements.closeCart.addEventListener('click', function () {\n    ClosePopup();\n});\n\nvar OpenPopup = function OpenPopup() {\n    document.querySelector('.cart__overlay').style.display = 'block';\n    document.querySelector('.cart__window').style.display = 'block';\n};\n\nvar ClosePopup = function ClosePopup() {\n    document.querySelector('.cart__overlay').style.display = 'none';\n    document.querySelector('.cart__window').style.display = 'none';\n};\n\n_base.elements.cartItems.addEventListener('click', function (e) {\n\n    if (e.target.matches('.removeQty')) {\n        var prId = e.target.closest('.removeQty').dataset.cartid;\n        var qty = parseInt(e.target.nextElementSibling.value);\n        e.target.nextElementSibling.value = parseInt(qty) - 1;\n        controlProductCart(prId, 'remove');\n        renderCartItems();\n    }\n    if (e.target.matches('.addQty')) {\n        var _prId = e.target.closest('.addQty').dataset.cartid;\n        var _qty = parseInt(e.target.previousElementSibling.value);\n        e.target.previousElementSibling.value = parseInt(_qty) + 1;\n        console.log(e.target.nextElementSibling.value);\n        controlProductCart(_prId, 'add');\n        renderCartItems();\n    }\n});\n\n//# sourceURL=webpack:///./src/js/cart.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _axios = __webpack_require__(/*! axios */ \"./node_modules/axios/index.js\");\n\nvar _axios2 = _interopRequireDefault(_axios);\n\nvar _config = __webpack_require__(/*! ../config */ \"./src/js/config.js\");\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step(\"next\", value); }, function (err) { step(\"throw\", err); }); } } return step(\"next\"); }); }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar Product = function () {\n    function Product() {\n        _classCallCheck(this, Product);\n    }\n\n    _createClass(Product, [{\n        key: 'getResults',\n        value: function () {\n            var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {\n                var res;\n                return regeneratorRuntime.wrap(function _callee$(_context) {\n                    while (1) {\n                        switch (_context.prev = _context.next) {\n                            case 0:\n                                _context.prev = 0;\n                                _context.next = 3;\n                                return (0, _axios2.default)('' + _config.proxy + _config.apiurl + 'products');\n\n                            case 3:\n                                res = _context.sent;\n\n                                this.result = res.data;\n                                _context.next = 10;\n                                break;\n\n                            case 7:\n                                _context.prev = 7;\n                                _context.t0 = _context['catch'](0);\n\n                                alert(_context.t0);\n\n                            case 10:\n                            case 'end':\n                                return _context.stop();\n                        }\n                    }\n                }, _callee, this, [[0, 7]]);\n            }));\n\n            function getResults() {\n                return _ref.apply(this, arguments);\n            }\n\n            return getResults;\n        }()\n    }, {\n        key: 'addToCart',\n        value: function () {\n            var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {\n                var res;\n                return regeneratorRuntime.wrap(function _callee2$(_context2) {\n                    while (1) {\n                        switch (_context2.prev = _context2.next) {\n                            case 0:\n                                _context2.prev = 0;\n                                _context2.next = 3;\n                                return _axios2.default.post('' + _config.proxy + _config.apiurl + 'addToCart');\n\n                            case 3:\n                                res = _context2.sent;\n\n                                this.result = res.data;\n                                _context2.next = 10;\n                                break;\n\n                            case 7:\n                                _context2.prev = 7;\n                                _context2.t0 = _context2['catch'](0);\n\n                                alert(_context2.t0);\n\n                            case 10:\n                            case 'end':\n                                return _context2.stop();\n                        }\n                    }\n                }, _callee2, this, [[0, 7]]);\n            }));\n\n            function addToCart() {\n                return _ref2.apply(this, arguments);\n            }\n\n            return addToCart;\n        }()\n    }]);\n\n    return Product;\n}();\n\nexports.default = Product;\n\n//# sourceURL=webpack:///./src/js/models/Product.js?");
...
"use strict";
eval("\n\nvar _Product = __webpack_require__(/*! ./models/Product */ \"./src/js/models/Product.js\");\n\nvar _Product2 = _interopRequireDefault(_Product);\n\nvar _productView = __webpack_require__(/*! ./views/productView */ \"./src/js/views/productView.js\");\n\nvar productView = _interopRequireWildcard(_productView);\n\nvar _Category = __webpack_require__(/*! ./models/Category */ \"./src/js/models/Category.js\");\n\nvar _Category2 = _interopRequireDefault(_Category);\n\nvar _categoryView = __webpack_require__(/*! ./views/categoryView */ \"./src/js/views/categoryView.js\");\n\nvar categoryView = _interopRequireWildcard(_categoryView);\n\nvar _base = __webpack_require__(/*! ./views/base */ \"./src/js/views/base.js\");\n\nvar _Cart = __webpack_require__(/*! ./models/Cart */ \"./src/js/models/Cart.js\");\n\nvar _Cart2 = _interopRequireDefault(_Cart);\n\nvar _cartView = __webpack_require__(/*! ./views/cartView */ \"./src/js/views/cartView.js\");\n\nvar cartView = _interopRequireWildcard(_cartView);\n\nfunction _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step(\"next\", value); }, function (err) { step(\"throw\", err); }); } } return step(\"next\"); }); }; }\n\n/** Global state of the app\r\n * - Product object\r\n * - Category object\r\n */\nvar pState = {};\n\n/** \r\n * Category CONTROLLER\r\n */\nvar controlCategory = function () {\n    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {\n        return regeneratorRuntime.wrap(function _callee$(_context) {\n            while (1) {\n                switch (_context.prev = _context.next) {\n                    case 0:\n\n                        // 1) New Category object and add to state\n                        pState.category = new _Category2.default();\n\n                        _context.prev = 1;\n                        _context.next = 4;\n                        return pState.category.getResults();\n\n                    case 4:\n\n                        // 3) Render results on UI\n                        categoryView.renderResultProductCategory(pState.category.result);\n                        _context.next = 10;\n                        break;\n\n                    case 7:\n                        _context.prev = 7;\n                        _context.t0 = _context['catch'](1);\n\n                        console.log(_context.t0);\n\n                    case 10:\n                    case 'end':\n                        return _context.stop();\n                }\n            }\n        }, _callee, undefined, [[1, 7]]);\n    }));\n\n    return function controlCategory() {\n        return _ref.apply(this, arguments);\n    };\n}();\n\n/** \r\n * Product CONTROLLER\r\n */\nvar controlProduct = function () {\n    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {\n        var filterKey;\n        return regeneratorRuntime.wrap(function _callee2$(_context2) {\n            while (1) {\n                switch (_context2.prev = _context2.next) {\n                    case 0:\n                        filterKey = window.location.hash.replace('#', '');\n\n                        // 1) New Carousel object and add to state\n\n                        pState.product = new _Product2.default();\n\n                        _context2.prev = 2;\n                        _context2.next = 5;\n                        return pState.product.getResults();\n\n                    case 5:\n\n                        pState.prductsArr = pState.product.result;\n\n                        // 3) Render results on UI\n                        productView.renderResults(pState.prductsArr, filterKey);\n                        _context2.next = 12;\n                        break;\n\n                    case 9:\n                        _context2.prev = 9;\n                        _context2.t0 = _context2['catch'](2);\n\n                        console.log(_context2.t0);\n\n                    case 12:\n                    case 'end':\n                        return _context2.stop();\n                }\n            }\n        }, _callee2, undefined, [[2, 9]]);\n    }));\n\n    return function controlProduct() {\n        return _ref2.apply(this, arguments);\n    };\n}();\n\n// On window load get data\nwindow.addEventListener('load', function () {\n\n    //Products\n    controlProduct();\n\n    //Category\n    controlCategory();\n\n    //Cart Items\n\n    controlCartItems();\n});\n\n// On Hash Change\n\nwindow.addEventListener(\"hashchange\", function (e) {\n\n    var hashKey = window.location.hash.replace('#', '');\n    productView.renderResults(pState.product.result, hashKey);\n    if (pState.category) categoryView.highlightSelected(hashKey);\n});\n\n_base.elements.mMenuNav.addEventListener('click', function (e) {\n\n    if (e.target.matches('.m-menu__link')) {\n        var hashKey = e.target.closest('.m-menu__link').dataset.phash;\n        if (window.location.hash.replace('#', '') == hashKey) {\n            location.hash = \"\";\n            event.preventDefault();\n        }\n    }\n});\n\ndocument.querySelector('#category-list').addEventListener('change', function () {\n    location.hash = document.querySelector('#category-list').value;\n});\n\n// Handling Product add button clicks\n\n_base.elements.productsContainer.addEventListener('click', function (e) {\n    if (e.target.matches('.buy-now')) {\n\n        var prId = e.target.closest('.buy-now').dataset.prid;\n\n        controlProductCart(prId, 'add');\n    }\n});\n\nvar controlCartItems = function controlCartItems() {\n\n    pState.cart = new _Cart2.default();\n\n    var cartList = pState.cart.getNumcartItem();\n\n    cartItems();\n};\n\n// Prodcut add To Cart\n\n\nvar controlProductCart = function () {\n    var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(prId, type) {\n        var products, index, product;\n        return regeneratorRuntime.wrap(function _callee3$(_context3) {\n            while (1) {\n                switch (_context3.prev = _context3.next) {\n                    case 0:\n\n                        try {\n\n                            // 1) Prdoucts List\n\n                            products = pState.product.result;\n\n                            //TODO remove comment\n                            // 2) Get Carousel lsit \n                            // await pState.product.addToCart();\n\n                            // if (pState.product.result.response === \"Success\") {\n                            // productView.addToCart(prId, products);\n\n\n                            index = products.findIndex(function (el) {\n                                return el.id === prId;\n                            });\n                            product = products[index];\n\n\n                            pState.cart.addToCart(product.id, product.name, product.price, product.imageURL, product.stock, 1, type);\n\n                            pState.cart.getNumcartItem();\n\n                            // }\n                        } catch (err) {\n                            console.log(err);\n                        }\n\n                    case 1:\n                    case 'end':\n                        return _context3.stop();\n                }\n            }\n        }, _callee3, undefined);\n    }));\n\n    return function controlProductCart(_x, _x2) {\n        return _ref3.apply(this, arguments);\n    };\n}();\n\n//Cart\n\nvar cartItems = function cartItems() {\n    cartView.clearCart();\n    cartView.renderCartItems(pState.cart.cartItems);\n};\n\n//# sourceURL=webpack:///./src/js/product.js?");
