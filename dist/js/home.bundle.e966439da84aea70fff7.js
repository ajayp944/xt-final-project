...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\nexports.renderResults = undefined;\n\nvar _base = __webpack_require__(/*! ./base */ \"./src/js/views/base.js\");\n\nvar renderResults = exports.renderResults = function renderResults(carousels) {\n    // carousels.reverse().forEach(renderCarousel);\n    carousels.reverse().forEach(function (value, key) {\n        if (value.isActive) {\n            renderCarousel(key, value);\n        }\n    });\n    showSlides();\n};\n\n// Render Carousel in view port\nvar renderCarousel = function renderCarousel(key, carousel) {\n\n    var markup = '\\n        <div class=\"carousel__items carousel__items--fade\">\\n            <img src=\"' + carousel.bannerImageUrl + '\" class=\"carousel__items--img\" alt=\"' + carousel.bannerImageAlt + '\" />\\n        </div>\\n    ';\n    _base.elements.carousel.insertAdjacentHTML('afterbegin', markup);\n    var carouselDotsMarkup = '<span class=\"carousel__dots--dot\" onclick=\"currentSlide(' + (key + 1) + ')\"></span>';\n    _base.elements.carouselDots.insertAdjacentHTML('afterbegin', carouselDotsMarkup);\n};\n\n// Carousel js lib\nvar slideIndex = 0;\nvar showSlides = function showSlides(n) {\n    var i = void 0;\n    var slides = document.getElementsByClassName(\"carousel__items\");\n    var dots = document.getElementsByClassName(\"carousel__dots--dot\");\n    for (i = 0; i < slides.length; i++) {\n        slides[i].style.display = \"none\";\n    }\n    slideIndex++;\n    if (slideIndex > slides.length) {\n        slideIndex = 1;\n    }\n    for (i = 0; i < dots.length; i++) {\n        dots[i].className = dots[i].className.replace(\" active\", \"\");\n    }\n    slides[slideIndex - 1].style.display = \"block\";\n    dots[slideIndex - 1].className += \" active\";\n    // setTimeout(showSlides, 10000); // Change image every 10 seconds\n};\n\n//# sourceURL=webpack:///./src/js/views/carouselView.js?");
...
/***/ 0:
/*!**************************************************************!*\
  !*** multi babel-polyfill ./src/js/home.js ./src/js/cart.js ***!
  \**************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

eval("__webpack_require__(/*! babel-polyfill */\"./node_modules/babel-polyfill/lib/index.js\");\n__webpack_require__(/*! ./src/js/home.js */\"./src/js/home.js\");\nmodule.exports = __webpack_require__(/*! ./src/js/cart.js */\"./src/js/cart.js\");\n\n\n//# sourceURL=webpack:///multi_babel-polyfill_./src/js/home.js_./src/js/cart.js?");
